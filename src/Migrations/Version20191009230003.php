 ...
 */
final class Version20191009230003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE societies ADD activity_id INT NOT NULL, DROP activity');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE societies ADD activity LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'(DC2Type:array)\', DROP activity_id');
