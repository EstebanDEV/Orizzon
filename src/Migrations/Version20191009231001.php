...
final class Version20191009231001 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE answer_id answer_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE societies ADD activity_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE answer_id answer_id INT NOT NULL');
    }
}
